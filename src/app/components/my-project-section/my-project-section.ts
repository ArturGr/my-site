  ...
  projects:ProjectList=[
    ...
    },
    {
      ...
      properties:{
        ...
        workProcess:"How do you keep your code clean and maintainable? Have you broken the project down into reusable modules or components? Focus on documentation, naming files, variables, classes and testing.",
        groupWorkExperience: "How many people were in the team and what was your role? Describe your tasks in 1-2 sentences, for example: login form, dashboard or chat functionality. What technologies did you use? It is nice to mention good teamwork and cooperation.",
        technologies: [this.iconMobile[2][2],this.iconMobile[3][2],this.iconMobile[4][2]],
        technologiesIMG: [this.iconMobile[2][0],this.iconMobile[3][0],this.iconMobile[4][0]],
        technologiesALT:[this.iconMobile[2][1],this.iconMobile[3][1],this.iconMobile[4][1]],
    ...
    },
    {
      ...
      properties:{
        ...
        workProcess:"Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et",
        groupWorkExperience: "Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et",
