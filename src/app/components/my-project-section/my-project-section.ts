  ...
  projects:ProjectList=[
    ...
    },
    {
      ...
      properties:{
        ...
        workProcess:"I managed my workflow using a Kanban-based approach, breaking down complex features into manageable subtasks to ensure timely delivery. By implementing a modular architecture with Angular Signals, I maintained a clean codebase and a highly responsive user interface.",
        workProcessDE:"Ich habe meinen Workflow nach der Kanban-Methode strukturiert und komplexe Funktionen in überschaubare Teilaufgaben zerlegt, um eine termingerechte Lieferung zu gewährleisten. Durch die Implementierung einer modularen Architektur mit Angular Signals habe ich eine saubere Codebasis und eine reaktionsschnelle Benutzeroberfläche sichergestellt.",
        groupWorkExperience: "I collaborated effectively in an Agile environment, maintaining high availability and providing technical support to my teammates. Through active communication and peer reviews, I helped foster a productive atmosphere focused on collective problem-solving.",
        groupWorkExperienceDE: "Ich habe effektiv in einem agilen Umfeld zusammengearbeitet, wobei ich stets erreichbar war und meine Teamkollegen technisch unterstützt habe. Durch aktive Kommunikation und Peer-Reviews habe ich zu einer produktiven Atmosphäre beigetragen, die auf gemeinsamer Problemlösung basierte.",
        technologies: [this.iconMobile[0][2],this.iconMobile[1][2],this.iconMobile[5][2],this.iconMobile[10][2],this.iconMobile[7][2]],
        technologiesIMG: [this.iconMobile[0][0],this.iconMobile[1][0],this.iconMobile[5][0],this.iconMobile[10][0],this.iconMobile[7][0]],
        technologiesALT:[this.iconMobile[0][1],this.iconMobile[1][1],this.iconMobile[5][1],this.iconMobile[10][1],this.iconMobile[7][1]],
        img: "./assets/img/projects/Join.png",
        git:"https://github.com/ArturGr/join-falk.git",
        live:"https://artur-groblicki.developerakademie.net/JOIN/index.html",
      }
    }
  ]
